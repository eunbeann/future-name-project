    ...
    <MainContainer bgImage={bg}>
      <div className="flex flex-col == items-center h-full">
        ...
        <div className="absolute top-[160px] bg-[#000000] xl:pt-[145px] xl:px-[70px] xl:w-[68%] xl:pb-[145px]">
          <div className="flex ml-[9px] justify-evenly w-full h-auto xl:pb-[35px]">
            <Link
              href={"project"}
              className="flex flex-col justify-center items-center gap-[20px]"
            >
              <Image
                className="xl:w-[140px] xl:h-[120px]"
                src={project}
                alt="projectIcon"
              />
              <p className="font-dunggeunmo text-[#ffffff] xl:text-[30px]">
                프로젝트 설명
              </p>
            </Link>
            <Link
          ...
          <p className="tracking-wide	xl:text-[22px] text-[#ffffff] whitespace-pre-wrap font-dunggeunmo text-center">
