...
export default function PersonCard({
  ...
  return (
    <div className="flex font-pixardisplay justify-between text-white hover:bg-white hover:text-[#031DDF] xl:text-[26px] mr-[3rem] xl:mr-[4rem] mb-[8px] xl:w-[457px] w-[339px]">
      <div className="flex">
