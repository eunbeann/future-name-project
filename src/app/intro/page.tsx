    ...
    <MainContainer bgImage={introBg}>
      <div className="flex justify-center items-center h-full">
        <div className="flex flex-col items-center w-[60%] h-full overflow-y-scroll scrollbar-hide bg-[#000000] px-[50px] py-[30px] font-dunggeunmo text-[#02FE00] text-center">
          ...
          />
          <Image
            className="w-[360px] mt-[60px]"
            src={introPerson}
            alt="intro-person"
          />
          <h1 className="mt-[10px] text-[26px] xl:text-[40px] xl:mb-[32px] xl:mt-[24px]">
            작명가 인사말
          </h1>
          <p className="mt-[10px] whitespace-break-spaces w-[75%] xl:text-[26px] tracking-wider leading-10">
